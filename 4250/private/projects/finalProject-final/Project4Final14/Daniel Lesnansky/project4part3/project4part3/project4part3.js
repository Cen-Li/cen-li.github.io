// Team: Le Hi and Daniel Lesnansky
// CSCI 4250
// Project 4 Part III
// Due: 12/3/2014

// This program draws the scene for a snake game
// The snake will be animated and move around the board avoiding obstacles and eating candy
// The scene consists of trees and cities
// Trees are drawn with cube and sphere primatives
// Cities are drawn with a cluster of cube primatives
// Additional shapes are polygonal mesh blimps and a purple sun plus extruded shape digits for scorekeeping
...
function DrawCity(xloc, zloc)
{
  ...
  //t=translate(xloc-0.01+0.2, .1*cityScale, zloc-0.01);
  ...
  //t=translate(xloc-0.01+0.2, .15*cityScale, zloc+0.01);
  ...
  //t=translate(xloc+0.01+0.2, .25*cityScale, zloc+0.01);
  ...
  //t=translate(xloc+0.01+0.2, .05*cityScale, zloc-0.01);
...
function render()
{
  ...
  */
  ...
  //      gl.uniform1i(gl.getUniformLocation(program, "texture"), 6);  // fragment shader to use gl.TEXTURE0
