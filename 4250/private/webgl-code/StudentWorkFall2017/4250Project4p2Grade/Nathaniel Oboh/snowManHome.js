...
var materialAmbient = vec4(1, .2, .2, 1.0);
var materialDiffuse = vec4(1.0, 0.5, 1, 1.0);
var materialSpecular = vec4(0, 1, 1, 1.0);
...
//***************************************
//Author: Nathaniel Oboh
//purpose: for surface of revolution object
//***************************************
...
function render() {
  ...
  materialDiffuse = vec4(1, 1, 150 / 255, 1.0);
  materialSpecular = vec4(200 / 255, 150 / 255, 40 / 255, 1.0);
  SetupLightingMaterial();

  mvMatrixStack.push(modelViewMatrix);
  t = translate(0.94, 0.12, 0.14);
