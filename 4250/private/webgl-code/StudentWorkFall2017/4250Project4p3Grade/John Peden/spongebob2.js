...
// buttons to change viewing parameters
    ...
    openNewTexture("textures/spongebobskin.jpg");
    openNewTexture("textures/pants.jpg");
    openNewTexture("textures/grilltop.jpg"); 
    openNewTexture("textures/othergrill.jpg"); 
    openNewTexture("textures/floor.jpg"); 
    openNewTexture("textures/wall.jpg"); 
    openNewTexture("textures/patty.jpg"); 
    openNewTexture("textures/shoes.jpg"); 
    openNewTexture("textures/spongebobface.jpg"); 
    openNewTexture("textures/pants_upsidedown.jpg"); 
