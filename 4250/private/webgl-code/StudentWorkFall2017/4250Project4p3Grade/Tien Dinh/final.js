...
var program;
var boatMoving = 0;
var boatStartingPosition = 0;

var xAxis = 0;
var yAxis = 1;
var zAxis = 2;
var axis = 1;
var amountOfRotation = 2.0;
var theta =[0, 0, 0];
...
*/
    ...
    projection = ortho(-10, 10, -8, 8, -20, 20);
    ...
    document.getElementById("ButtonR").onclick = function(){amountOfRotation *= -1;};
...
var render = function()
{
    ...
    var thisvector = lookAt(vec3(0, 0, 8), vec3(0, 0, 0), vec3(0, 1, 0));
    var t1 = translate(1,0,0);
    var r1 = rotate(30, 0, 1, 0);

    // Rotate boat + objects
    var r2Boat = rotate(boatStartAngle + boatAngle,-boatStartAngle - boatAngle,
                            boatStartAngle + boatAngle,1);
    var t2Boat = translate(-4 + boatMoving, 0, boatStartingPosition);
    modelViewMatrix=mult(mult(modelViewMatrix, t2Boat), r2Boat);
    gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(modelViewMatrix));
        ...
        function ()
          {
            if (pillarStartRotating == 1)
            {
                ...
                {
                    boatMoving = 0;
                    boatStartingPosition = Math.random()*6 - 3;
                }
