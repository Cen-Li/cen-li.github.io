...
window.onload = function init() {
	...
	document.getElementById("description").addEventListener("click", function(press)
    {
		alert("5 objects have been implemented so far.\n\n" +
		      "Room: Composed of cubes drawn 4(5) times, scaled, and rotated as needed\n\n" +
		      "Door: Similarly composed of cubes scaled to fit, with the addition of a half " +
		            "circle for the top and a full circle for the doorknob\n\n" +
		      "Christmas Tree: Rendered using surface of revolution, although with a strange fix. " +
		            "The stump is rendered as a full circle with additional height\n\n" +
		      "Fireplace: composed of 7 cubes scaled to fit the desired shape\n\n" +
		      "4-pointed star: Rendered using polygonal mesh techniques. This object was created " +
		                      "mostly to test mesh techniques that I can use for more complex objects\n\n" +
		      "Camera controls have already been implemented, but are disabled by default. They can be toggled " +
		      "using the radio button provided or by pressing the 'e' key.\n\n" +
		      "Also provided is a togglable ceiling, created with the intention of perhaps creating hanging " +
		      "objects, such as a chandelier. Togglable with the provided button or by pressing the 'c' key.\n\n" +
		      "Lastly, a render toggle has been provided that simply changes the render type to gl.LINE_STRIP or " +
		      "gl.TRIANGLES, based on which one is currently active. Togglable using provided button or with the 'r' key.");
    });
