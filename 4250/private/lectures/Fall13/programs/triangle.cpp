...
int main(int argc, char* argv[])
{
	...
	glutAddMenuEntry("Toggle outline back",2);
	glutAddMenuEntry("Toggle face culling",3);
...
void RenderScene(void)
{
	...
	glPushMatrix();
	glRotatef(xRot, 1.0f, 0.0f, 0.0f);  // the rotation takes effect after user enters key commands
	glRotatef(yRot, 0.0f, 1.0f, 0.0f);  // see function "SpecialKeys()" below 
