/*
 ...
 using simple menu in GLUT window
 
 When the right button is pressed, a menu with different color choice 
 is displayed, selecting the color with change the color of the cube displayed.
