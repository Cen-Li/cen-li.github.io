...
int ReadCities(ifstream& myIn, city tncities[]);
void DisplayCities(city tncities[], int count);
...
int main()
{
	...
	myIn.open("cities.dat");
        ...
        count = ReadCities(myIn, tncities);

        DisplayCities(tncities, count);
