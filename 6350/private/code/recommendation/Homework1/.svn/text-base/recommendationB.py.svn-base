#This is wirtten by Sachintha Pitigala
...
# compute the Manhattan distance between two person's preferences
def sim_distance(prefs, person1, person2):
	...
	manhattan_distance = (sum([abs(prefs[person1][it] - prefs[person2][it]) for it in si]))
...
if __name__ == '__main__':
	...
	#copy the first 100 person to the training list
	for person in prefs:
	...
	for person in training:
		...
		#store to original ratings
		originalrating={}
		#store the new calculated ratings
		newrating={}
		...
		for item in itemsforperson:
			...
			recommendations = getRecommendations(prefs, person, sim_distance)
			
			#search for the claculated ratings
