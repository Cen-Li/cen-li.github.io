#This program modified by Sachintha Pitigala
...
if __name__ == '__main__':
	...
	#copr the first 100 person to the training list
	for person in prefs:
	...
	for person in training:
		#remove the person for the main dictionary
		prefs.pop(person)
		
		#to store original ratings
		originalrating={}
		#to store new calculated ratings
		newrating={}
		#store the copy of persons data
		copy={}
		itemsforperson=[]
		
		#make a copy of selected person
		...
		#add the person back to the dictionary
