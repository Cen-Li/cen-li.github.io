...
if __name__ == '__main__':
  ...
  print '\nTop matching movies for Mission Impossible (1996) :\n'
  bestMatches = topMatches(movies, 'Mission: Impossible (1996)')
  print bestMatches
  print '\n'

  #get recommendations
  print 'Users to invite for Mission Impossible (1996):\n'
  recommendations = getRecommendations(movies, 'Mission: Impossible (1996)', sim_pearson)
