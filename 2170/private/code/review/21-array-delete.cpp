...
// list (IN): the list of items to be displayed
// number (IN): the number of items in the list
void PrintList(string list[], int number)
{
    int i;
...
// list (IN/OUT) : The list of items
// number (IN/OUT) : the number of items in the list, will increase by 1 if a successful insertion is performed
// location (IN) : The location of the item to be deleted in the list
void DeleteAtLocation(string list[], int &number, int location)
{
    int i;
