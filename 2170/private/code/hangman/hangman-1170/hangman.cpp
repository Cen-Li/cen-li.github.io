...
void PlayGame(char selectedWord[])
{
    ...
    int badGuess=6;             //bad guess counter
    ...
    //This for loop initalizes all of the elements in gameBoard array to *
    ...
    while(!win && badGuess>0)
    {
        ...
        {
            badGuess--;
            cout << "Sorry, bad guess! You have " << badGuess
                    << " bad guesses left." << endl;
        }
