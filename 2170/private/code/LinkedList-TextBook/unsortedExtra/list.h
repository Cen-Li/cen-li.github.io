// header file for unsorted list class
...
public:
  ...
  void Print();  // print all the values in the list

  ItemType ComputeSum();  // computes and returns the sum of all the values in the list
  
  ItemType GetIthValue(int location); // return the ith value in the list
  ...
  friend istream&  operator >>  (istream & in, List &  rhs);
