...
class FlightMapClass
{
	public:
		...
		bool GetNextCity(int fromCity, int & nextCity);
		...
		//Pre-condition: originCity and destinationCity are the city
		//				numbers of the origin and destination city, respectively
	...
	private:
		...
		string* cities;			//list of cities
		bool* visited;			//records whether a city has been visited
		SortedListClass* map;	//flight map
};
