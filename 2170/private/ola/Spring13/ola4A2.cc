...
int main()
{
    ...
    cout << "The Creature is at (" << myCreature.RetrieveLocation().row << ' ' << myCreature.RetrieveLocation().col << ")\n";
   ...
   for(int i = 0; i < 3; i++)  //moves the creature for as long as the loop lasts
    ...
    cout << "The Creature is now at (" << myCreature.RetrieveLocation().row << ' ' << myCreature.RetrieveLocation().col << ")\n";
