...
void StoreClass::readFile(string filename)
{
	...
	filename = "2170_7_3Data.0";  //this is the data file used
...
//This constructor receives the name of the datafile through
//the argument list.  All store data is read from that file.
//Place first line of code here for the overloaded constructor
{
	string input;                 //input a string from the file
	ifstream myFile;              //input file stream
	totalChairs = 0;              //set the chair counter to 0
	...
	//Place code here to open the file and check for file
	//failure.
